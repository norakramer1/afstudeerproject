  ...
  return (
    <div className="Events">
      ...
      <div className="Review-header">
        <h2 className="Review-title">Wat vond je van dit evenement?</h2>
        <p className="Review-description">
          Deel je mening met jou vrienden en help ze bij het maken van een
          keuze.
        </p>
        <Link to="/review" className="Nav-account-link">
          <button className="onboarding-start">Review dit evenement</button>
        </Link>
      </div>
